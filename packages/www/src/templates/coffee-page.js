						...
						<header className="flex p-3 sm:mt-6 space-x-4">
							...
							<div className="flex-grow flex w-1/3 sm:w-1/2 items-center space-x-1">
								<div class="relative w-full shadow-sm">
									<input id="search" class="form-input w-full block p-2 sm:text-sm sm:leading-5" />
							...
							<div className="w-1/3 flex sm:hidden justify-end items-center space-x-2">
								<div className="pl-4 space-x-4 items-center flex">
									...
									>
										<Icon icon="hamburger" size="lg" className="text-gray-700" />
									</HeaderButton>
								</div>
							</div>
						</header>
						...
						<div className="p-4 sm:p-0 flex-grow flex flex-col items:center">
							<section className="relative m-0 sm:py-12">
								<div className="space-y-4">
									...
									<figure className="-mr-40 sm:-mr-32 right-0 top-0 z-10 sm:absolute mr-3">
									...
									<div className="sm:mx-0 w-56 sm:w-64 text-sm sm:text-base leading-loose">
										...
										<p className="">
											<Icon icon="map-marker" /> from <span className="font-bold">{origin}</span>
										</p>
										<p className="">
											<Icon icon="leaf" /> grown by <span className="font-bold">{grown}</span>
										</p>
										<p className="">
											<Icon icon="weight-hanging" /> <strong>{weight}</strong> per bag
										</p>
									</div>
							...
							<section className="pr-4 mt-8 mb-4 space-x-1 flex items-center">
								<p className="text-xs font-serif italic flex-grow">Built with Gatsby</p>
								<Hyperlink href="https://github.com/imalbert">
									<Icon icon={faGithub} size="lg" className="text-gray-700" />
								</Hyperlink>
								<Hyperlink href="https://www.linkedin.com/in/albertsmanuel/">
					...
					<aside className="fixed right-0 bottom-0">
						<nav className="mr-2 mb-2 sm:mr-8 sm:mb-8 w-12 h-12 bg-primary sm:bg-white bottom-0 right-0 rounded-full flex items-center justify-center absolute">
							<div className="relative">
								<Icon icon="shopping-cart" size="lg" className="text-white sm:text-primary m-1" />
...
export const query = graphql`
	query($slug: String) {
		...
		mobileImage: file(relativePath: { eq: "coffee/cup-coffee-plastic-transparent.png" }) {
			childImageSharp {
		...
		desktopImage: file(relativePath: { eq: "coffee/cup-coffee-plastic-transparent.png" }) {
			childImageSharp {
